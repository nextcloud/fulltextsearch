OC.L10N.register(
    ...
    "Failed to reach server. Try reloading the page" : "Failed to reach server. Try reloading the page",
    "{title} — {total} results in {time} ms" : "{title} — {total} results in {time} ms",
    "Search filters" : "Search filters",
    "Search on {theme}" : "Search on {theme}",
    "Error" : "Error",
