OC.L10N.register(
    ...
    "Failed to reach server. Try reloading the page" : "Sunucuya erişilemiyor. Sayfayı yeniden yüklemeyi deneyin",
    "{title} — {total} results in {time} ms" : "{title} —  {time} ms içinde {total} sonuç",
    "Search filters" : "Arama süzgeçleri",
    "Search on {theme}" : "{theme} içinde ara",
    "Error" : "Hata",
    "Search for content" : "İçerik ara",
    "Searching …" : "Aranıyor…",
