OC.L10N.register(
    ...
    "Test update document query" : "Testa uppdatera dokumenteringsfråga",
    ...
    "Error updating field - Can't find original document - (Error #%1$s)" : "Fel när fält uppdaterades - Kunde inte hitta originaldokumentet - (Fel #%1$s)",
    ...
    "Nextant" : "Nextant",
    "Nextant (Full-Text Search)" : "Nextant (Fulltextsökning)",
    "Specify the address of your Solr, and the name of the core to use." : "Specificera adressen till din Solr och namnet till kärnan som ska användas",
    ...
    "Indexing in progress" : "Indexering pågår",
