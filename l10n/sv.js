OC.L10N.register(
    ...
    "General" : "Allmänt",
    "Please check the wiki for documentation related to the installation and the configuration of the full text search within your Nextcloud." : "Läs wikin för dokumentation om installation och konfigurering av fulltextsökning i Nextcloud.",
    ...
    "Failed to reach server. Try reloading the page" : "Det gick inte att nå servern. Försök läsa in sidan igen",
    "{title} — {total} results in {time} ms" : "{title} — {total} resultat på {time} ms",
    "Search filters" : "Sökfilter",
    "Search on {theme}" : "Sök på {theme}",
    "Error" : "Fel",
