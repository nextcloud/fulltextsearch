OC.L10N.register(
    ...
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Se presentó una falla en la extracción. Por favor verficia la configuración en tu servidor Solr (Error #%1$s)",
    "Error updating field - Can't find original document - (Error #%1$s)" : "Se presentó un error al actualizar el campo - No se puede encontrar el documento orginal - (Error #%1$s)",
    ...
    "\"App Bookmarks\" enabled, your bookmarks will be indexed." : "La \"Aplicación de Marcadores\" está habilitada, tus marcadores serán indexados. ",
    ...
    "Indexing is scheduled within the next few hours (Cron)" : "La indexación esta calendarizada para dentro de las próximas horas (Cron)",
