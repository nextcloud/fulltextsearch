OC.L10N.register(
    ...
    "Failed to reach server. Try reloading the page" : "Не вдалося з'єднатися з сервером. Оновіть сторінку",
    "{title} — {total} results in {time} ms" : "{title} — {total} результатів за {time} мс",
    "Search filters" : "Фільтри пошуку",
    "Search on {theme}" : "Шукати у {theme}",
    "Error" : "Помилка",
    "Search for content" : "Шукати серед вмісту",
    "Searching …" : "Шукаю...",
