OC.L10N.register(
    ...
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Wyodrębnianie nie powiodło się. Sprawdź proszę konfigurację swojego serwera Solr (Błąd #%1$s)",
    ...
    "Could not delete test-document. Please check the configuration of your Solr server (Error #%1$s)" : "Nie można usunąc dokumentu testowego. Sprawdź konfigurację swojego serwera Solr (Błąd #%1$s)",
    ...
    "If you do not have a Solr servlet running, you can find few guides on how to install one on the wiki." : "Jeśli nie posiadasz własnego serwletu Solr, na wiki znajdziesz przewodnik jak go zainstalować.",
    ...
    "it is recommended to do the very first indexing of your files using the ./occ nextant:index command." : "Zalecamy, aby pierwsze indeksowanie plików wykonać poprzez komendę ./occ nextant:index.",
