OC.L10N.register(
    ...
    "Failed to reach server. Try reloading the page" : "サーバーに接続できませんでした。ページを再読み込みしてください。",
    "{title} — {total} results in {time} ms" : "{title} — {total}件の結果が {time}ミリ秒で表示されました",
    "Search filters" : "検索条件",
    "Search on {theme}" : "{theme}で検索",
    "Error" : "エラー",
    "Search for content" : "コンテンツを検索",
    "Searching …" : "検索しています…",
    "No results" : "該当なし",
    "Previous page" : "前のページ",
    "Next page" : "次のページ",
