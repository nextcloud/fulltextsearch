OC.L10N.register(
    "fulltextsearch",
    {
    "the search returned {total} results in {time} ms" : "ئىزدەش {ۋاقىت} ms دىكى {ئومۇمىي} نەتىجىنى قايتۇردى",
    "the search in {title} for \"{search}\" returned {total} results in {time} ms" : "{title} دىكى ئىزدەش {{ئىزدەش} \"{ۋاقىت} ms دىكى {ئومۇمىي} نەتىجىگە قايتتى",
    "Search" : "Search",
