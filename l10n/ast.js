OC.L10N.register(
    ...
    "Were not able to verify/fix schema integrity (Error #%1$s)" : "Nun foi posible verificar/iguar la integridá del esquema (Fallu #%1$s)",
    "Extract failed. Please check the configuration of your Solr server (Error #%1$s)" : "Falló la estraición. Comprueba la configuración del to sirvidor Solr, por favor. (Fallu #%1$s)",
    "Error during commit (Error #%1$s)" : "Fallu nel unviu (Fallu #%1$s)",
    "Error during updating field (Error #%1$s)" : "Fallu nel campu de xuba (Error #%1$s)",
    ...
    "Configuration failed to be saved. Please reload this page." : "La configuración falló al guardase. Recarga esta páxina, por favor.",
    "Nextant" : "Nextant",
