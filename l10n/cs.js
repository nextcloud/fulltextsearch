OC.L10N.register(
    ...
    "Unable to verify/fix schema integrity (Error #%1$s)" : "Nepodařilo se ověřit/opravit integritu schématu (chyba #%1$s)",
    "Text extracted" : "Text extrahován",
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Extrakce selhala. Zkontrolujte konfiguraci vašeho Solr serveru (chyba #%1$s)",
    ...
    "Error while updating field (Error #%1$s)" : "Chyba při aktualizaci pole (chyba #%1$s)",
    "Document updated" : "Dokument aktualizován",
    "Found it" : "Nalezeno",
    "Found something, but not what was expected." : "Něco bylo nalezeno, ale ne to, co bylo očekáváno",
    ...
    "Could not delete test-document. Please check the configuration of your Solr server (Error #%1$s)" : "Nepodařilo se smazat zkušební dokument. Prosím, zkontrolujte konfiguraci vašeho Solr serveru (chyba #%1$s)",
    "Your configuration has been saved" : "Vaše konfigurace byla uložena",
    "Configuration could not be saved. Please reload this page." : "Konfiguraci se nepodařilo uložit. Prosím, obnovte tuto stránku.",
    "Nextant" : "Nextant",
    ...
    "Index File Trash:" : "Odpad indexového souboru:",
    ...
    "Number of segments:" : "Počet segmentů:",
    "it is recommended to do the very first indexing of your files using the ./occ nextant:index command." : "doporučujeme dělat první indexování vašich souborů pomocí příkazu ./occ nextant:index.",
