OC.L10N.register(
    ...
    "Ping querying your Solr Server" : "Ping sucht Ihren Solr Server",
    ...
    "Apache Solr is up, running and responding to ping query" : "Apache Solr läuft und antwortet auf Ping-Anfragen",
    "Apache Solr is not responding to ping query (Error #%1$s)" : "Apache Solr antwortet nicht auf Ping-Anfragen (Fehler #%1$s)",
    "Schema is fine" : "Schema ist in Ordnung",
    "Unable to verify/fix schema integrity (Error #%1$s)" : "Schemenintegrität konnte nicht überprüft / repariert werden (Fehler #%1$s)",
    "Text extracted" : "Text extrahiert",
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Extrahierung fehlgeschlagen. Bitte Prüfen Sie die Kofiguration Ihres Solr Servers (Fehler #%1$s) ",
    ...
    "Search failed. Please check the configuration of your Solr server (Error #%1$s)" : "Suche fehlgeschlagen. Bitte prüfen Sie die Konfiguration Ihres Solr Servers (Fehler #%1$s)",
    "Test-document deleted" : " Test-Dokument gelöscht ",
    "Could not delete test-document. Please check the configuration of your Solr server (Error #%1$s)" : "Test-Dokument konnte nicht gelöscht werden. Bitte prüfen Sie die Konfiguration Ihres Solr Servers (Fehler #%1$s) ",
    ...
    "If you do not have a Solr servlet running, installation-guides can be found on the wiki." : "Wenn Sie noch kein Solr-Servlet laufen haben, finden Sie Installationsanleitungen im Wiki. ",
    "You can also find more information there about this interface." : "Dort finden Sie weitere Informationen zu diesem Interface.",
    "Saving" : "Speichere",
    "Settings" : "Einstellungen",
    "Nextant version:" : "Nextant-Version : ",
    "Address of your Solr servlet:" : "Adresse Ihres Solr-Servlet: ",
    "Core:" : "Kern:",
    ...
    "\"App Bookmarks\" enabled, your bookmarks will be indexed." : "Die Lesezeichen App ist aktiviert, Ihre Lesezeichen werden indexiert",
    "Checking" : "Prüfe",
    ...
    "Text File (Text, HTML, Subtitles, Source Code…)" : " Text-Datei (Text, Html, Subtitles, Quell-Code, …) ",
