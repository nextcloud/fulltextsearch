OC.L10N.register(
    ...
    "Failed to reach server. Try reloading the page" : "Impossible de joindre le serveur. Essayez de recharger la page.",
    "{title} — {total} results in {time} ms" : "{title} — {total} résultats en {time} ms",
    "Search filters" : "Filtres de recherche",
    "Search on {theme}" : "Rechercher dans {theme}",
    "Error" : "Erreur",
    "Search for content" : "Rechercher du contenu",
