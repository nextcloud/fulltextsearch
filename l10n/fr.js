OC.L10N.register(
    ...
    "Unable to verify/fix schema integrity (Error #%1$s)" : "Impossible de vérifier/réparer le schéma (Erreur #%1$s)",
    "Text extracted" : "Texte extrait",
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Échec de l'extraction. Veuillez vérifier la configuration de votre serveur Solr (Erreur #%1$s)",
    ...
    "Found it" : "Trouvé",
    "Found something, but not what was expected." : "Quelque chose a été trouvé. Mais rien à voir. Du tout.",
    ...
    "Could not delete test-document. Please check the configuration of your Solr server (Error #%1$s)" : "Échec de la suppression de notre document de test. Veuillez vérifier la configuration de votre serveur Solr (Erreur #%1$s)",
    "Your configuration has been saved" : "Votre configuration a été sauvegardée",
    "Configuration could not be saved. Please reload this page." : "Votre configuration n’a pas pu être sauvegardée. Merci de rafraîchir cette page.",
    "Nextant" : "Nextant",
    ...
    "You can also find more information there about this interface." : "Vous pouvez aussi trouver plus d'information ici à propos de cette interface.",
    "Saving" : "Sauvegarde",
    ...
    "Minimum Background Index delay:" : "Intervalle minimal de synchronisation en arrière plan :",
    "hours" : "heures",
    "Maximum Background Index delay:" : "Intervalle maximal de synchronisation en arrière plan :",
    "days" : "jours",
    "Nextcloud Cron:" : "Cron Nextcloud :",
    "Number of documents:" : "Nombre de documents :",
    "Number of segments:" : "Nombre de segments :",
    "it is recommended to do the very first indexing of your files using the ./occ nextant:index command." : "Il est recommandé de lancer la première indexation de vos fichiers en utilisant la commande ./occ nextant:index",
