OC.L10N.register(
    ...
    "Address-format incorrect" : "Onjuist adresformaat",
    ...
    "Unable to verify/fix schema integrity (Error #%1$s)" : " We kunnen het schema integriteit niet verifiëren/herstellen (Error #%1$s)",
    "Text extracted" : "Tekst uitgepakt",
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Uitpakken mislukt. Verifieer de configuratie van je Solr server (fout #%1$s)",
    "Error updating field - Can't find original document - (Error #%1$s)" : "Fout bij bijwerken veld - kan originele document niet vinden - (Fout #%1$s)",
    ...
    "\"App Bookmarks\" enabled, your bookmarks will be indexed." : "\"App Bladwijzers\" ingeschakeld, je bladwijzers worden geïndexeerd.",
    ...
    "Indexing is scheduled within the next few hours (Cron)" : "Indexeren is gepland in de komende paar uur (cron)",
