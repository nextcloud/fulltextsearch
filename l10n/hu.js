OC.L10N.register(
    ...
    "Address-format incorrect" : "Hibás címformátum",
    ...
    "Unable to verify/fix schema integrity (Error #%1$s)" : "Nem lehet ellenőrizni/javítani a séma integritást (Hiba #%1$s)",
    "Text extracted" : "Szöveg kinyerve",
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Kibontás sikertelen. Kérlek ellenőrizd a Solr szerver beállításait (Error #%1$s)",
    ...
    "Error while updating field (Error #%1$s)" : "Hiba a mező frissítése közben (Hiba #%1$s)",
    "Document updated" : "Dokumentum frissítve",
    "Found it" : "Megvan",
    "Found something, but not what was expected." : "Talátunk valamit, de nem azt amire számítottunk.",
    ...
    "Could not delete test-document. Please check the configuration of your Solr server (Error #%1$s)" : "Próbadokumentum nem törölhető. Kérlek ellenőrizd a Solr szervered beállítását (Hiba #%1$s)",
    "Your configuration has been saved" : "A beállításaid el lettek mentve",
    "Configuration could not be saved. Please reload this page." : "Beállítások nem menthetők. Kérlek frissítsd ezt a lapot.",
    "Nextant" : "Nextant",
    ...
    "If you do not have a Solr servlet running, installation-guides can be found on the wiki." : "Ha nincs futó Solr szervlet futtatód, a telepítési útmutató a wikin található.",
    "You can also find more information there about this interface." : "Ugyanott találsz információt erről az interfészről.",
    "Saving" : "Mentés",
    "Settings" : "Beállítások",
    "Nextant version:" : "Nextant verzió:",
    "Address of your Solr servlet:" : "Solr szervlet címe:",
    "Core:" : "Mag:",
    "Timeout (in seconds):" : "Lejárat (másodpercben):",
    ...
    "Index File Trash:" : "Fájl szemetes indexelése:",
    "Index Public Links:" : "Publikus linkek indexelése:",
    "Index Federated Shares:" : "Egyesített megosztások indexelése:",
    "Index External Storages:" : "Külső tárolók indexelése:",
    ...
    "\"App Bookmarks\" enabled, your bookmarks will be indexed." : "Az alkalmazás könyvjelzők be vannak kapcsolva, indexelve lesznek.",
    "Checking" : "Ellenőrzés",
    ...
    "Live Index:" : "Élő index:",
    "Disabled" : "Letiltva",
    "Using Semaphore" : "Semaphore használata",
    "Using Database" : "Adatbázis használata",
    "Minimum Background Index delay:" : "Minimális háttér indexelési csúszás:",
    "hours" : "óra",
    "Maximum Background Index delay:" : "Maximális háttér indexelési csúszás:",
    "days" : "nap",
    "Nextcloud Cron:" : "Nextcloud Cron:",
    "Number of documents:" : "Dokumnetumok száma:",
    "Number of segments:" : "Szegmensek száma:",
    "it is recommended to do the very first indexing of your files using the ./occ nextant:index command." : "Ajánlott az első indexelésedet a következővel végeztetni: ./occ nextant:index",
    ...
    "Indexing is scheduled within the next few hours (Cron)" : "Az indexelés a következő pár órára van időzítve",
    "Indexing in progress" : "indexelés folyamatban",
    "Type of files to extract" : "Kibontandó fájlok típusa",
    "Text File (Text, HTML, Subtitles, Source Code…)" : "Szövegfájl (Szöveg, HTML, Feliratok, Forráskód…)",
    "EPUB / PDF / RTF" : "EPUB / PDF / RTF",
    "Office Documents" : "Office dokumentumok",
    "Image (JPEG, TIFF)" : "Kép (JPEG, TIFF)",
    "Audio File (MP3, FLAC)" : "Hangfájl (MP3, FLAC)",
