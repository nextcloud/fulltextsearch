OC.L10N.register(
    ...
    "Test update document query" : "Testar uma consulta de atualização de documento",
    ...
    "Address-format incorrect" : "Formato do endereço errado",
    ...
    "Unable to verify/fix schema integrity (Error #%1$s)" : "Não foi possível verificar/reparar a integridade do schema (Erro #%1$s)",
    "Text extracted" : "Texto extraído",
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "A extração falhou. Verifique a configuração do servidor Solr (Erro #%1$s)",
    ...
    "Found it" : "Encontrado",
    "Found something, but not what was expected." : "Foi encontrado algo mas não era o esperado.",
    ...
    "Could not delete test-document. Please check the configuration of your Solr server (Error #%1$s)" : "Não foi possível excluir o documento de teste. Verifique a configuração do servidor Solr (Erro #%1$s)",
    "Your configuration has been saved" : "Sua configuração foi salva",
    "Configuration could not be saved. Please reload this page." : "A configuração não foi salva. Atualize a página.",
    "Nextant" : "Próxima",
    ...
    "If you do not have a Solr servlet running, installation-guides can be found on the wiki." : "Se você não tem um servlet Solr rodando, guias de instalação podem ser encontrados no wiki.",
    "You can also find more information there about this interface." : "Você também pode encontrar mais informações lá sobre essa interface.",
    "Saving" : "Salvando",
    "Settings" : "Configurações",
    "Nextant version:" : "Próxima versão:",
    "Address of your Solr servlet:" : "Endereço de seu servlet Solr:",
    "Core:" : "Núcleo:",
    "Timeout (in seconds):" : "Timeout (em segundos):",
    "Test and Save" : "Testar e Salvar",
    "Indexing Files" : "Indexando Arquivos",
    "Maximum File Size (Mb):" : "Tamanho Máximo de um Arquivo (MB):",
    "Edit your filters" : "Editar seus filtros",
    "Index Files Tree:" : "Árvore de Arquivos de Índice:",
    ...
    "\"App Bookmarks\" enabled, your bookmarks will be indexed." : "Aplicativo \"Bookmarks\" habilitado. Seus favoritos serão indexados.",
    ...
    "Live Index:" : "Indexação ao Vivo:",
    "Disabled" : "Desabilitado",
    "Using Semaphore" : "Utilizando Semáforo",
    "Using Database" : "Usando Banco de Dados",
    "Minimum Background Index delay:" : "Atraso Mínimo na Indexação em Retaguarda:",
    "hours" : "horas",
    "Maximum Background Index delay:" : "Atraso Máximo na Indexação em Retaguarda:",
    "days" : "dias",
    "Nextcloud Cron:" : "Cron Nextcloud:",
    "Number of documents:" : "Número de documentos:",
    "Number of segments:" : "Número de segmentos:",
    "it is recommended to do the very first indexing of your files using the ./occ nextant:index command." : "É recomendável fazer a primeira indexação de seus arquivos usando o comando ./occ nextant: index.",
    ...
    "Indexing is scheduled within the next few hours (Cron)" : "A indexação está programada para dentro de algumas horas (Cron)",
    ...
    "Audio File (MP3, FLAC)" : "Arquivo de Áudio (MP3, FLAC)",
