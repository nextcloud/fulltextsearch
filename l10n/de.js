OC.L10N.register(
    ...
    "Ping querying your Solr Server" : "Ping sucht Deinen Solr Server",
    ...
    "Extraction failed. Please check the configuration of your Solr server (Error #%1$s)" : "Extrahierung fehlgeschlagen. Bitte Prüfe die Kofiguration des Solr-Servers (Fehler #%1$s) ",
    ...
    "Search failed. Please check the configuration of your Solr server (Error #%1$s)" : "Suche fehlgeschlagen. Bitte prüfe die Konfiguration Deines Solr Servers (Fehler #%1$s)",
    "Test-document deleted" : "Test-Dokument gelöscht",
    "Could not delete test-document. Please check the configuration of your Solr server (Error #%1$s)" : "Testdokument konnte nicht gelöscht werden. Bitte prüfe die Konfiguration Deines Solr Servers (Fehler #%1$s) ",
    ...
    "If you do not have a Solr servlet running, installation-guides can be found on the wiki." : " 99% match\nWenn Du noch kein Solr-Servlet laufen hast, findest Du Installationsanleitungen im Wiki. ",
    ...
    "\"App Bookmarks\" enabled, your bookmarks will be indexed." : "Die Lesezeichen App ist aktiviert, Deine Lesezeichen werden indexiert",
    "Checking" : "Prüfe",
    ...
    "However, you can force it to be started as a background process." : "Du kannst jedoch erzwingen, dass es als Hintergrundprozess gestartet wird.",
