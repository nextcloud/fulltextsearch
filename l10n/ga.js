OC.L10N.register(
    ...
    "Failed to reach server. Try reloading the page" : "Theip ar an bhfreastalaí teacht air. Bain triail as an leathanach a athlódáil.",
    "{title} — {total} results in {time} ms" : "{title} — {total} torthaí i {time} ms",
    "Search filters" : "Scagairí cuardaigh",
    "Search on {theme}" : "Cuardaigh ar {theme}",
    "Error" : "Earráid",
    "Search for content" : "Cuardaigh ábhar",
