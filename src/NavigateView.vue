...
/**
 * @return the `provider` id (not app id) of every enabled Content Provider, or 'all' if none was
...
/** @return the merged option values of every enabled Content Provider, as the search API expects them. */
